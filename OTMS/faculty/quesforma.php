...
if($result==TRUE)
     {
      ...
      echo "Select the course from the list You want to create test (manually) for ";
	 echo '<table class="table table-striped">';
	 echo "<thead><th>Course</th>.<th>Questions Added</th></thead><tbody>";
     while($db_feild=mysql_fetch_assoc($result))
	 {
	 	 echo "<tr><td><a href=\"quesform1.php?course=".$db_feild['C_id']."\">".$db_feild['C_id']."</a></td><td>".$db_feild['setted']."</td></tr>";
	 }
	 echo "</tbody></table>";
   echo "</div>";
	 }
